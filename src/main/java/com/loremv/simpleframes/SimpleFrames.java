...
public class SimpleFrames implements ModInitializer {
	...
	public static final FrameSlabVertical FRAME_SLAB_VERTICAL = new FrameSlabVertical("block/framed_slab_vertical");
	public void registerBlocks()
	{
		...
		Registry.register(Registries.BLOCK,new Identifier("simpleframes","framed_slab_vertical"),FRAME_SLAB_VERTICAL);
	}
	...
	public void registerItems()
	{
		...
		Registry.register(Registries.ITEM,new Identifier("simpleframes","framed_slab_vertical"),new BlockItem(FRAME_SLAB_VERTICAL,new Item.Settings()));
